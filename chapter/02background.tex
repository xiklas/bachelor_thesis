...
Also, because we do not want to validate the instruction on the same data source we obtained the street networks from, we will not use OpenStreetMap for this purpose.
Instead we will use a tried and tested commercial prouct called Google Maps.
