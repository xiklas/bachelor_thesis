...
Next, we may analyze the failures in the test group by the dataset they occured on.
...
Setting aside the 22 cases where all models either answered correctly or incorrectly, we are left with 18 trials where the results were ambiguous.
...
Out of the 18 ambiguous trials, GPT-4o and Gemini 2.5 disagreed in 15 cases, while agreeing on 3 cases.
The next highest disagreement count was observed in the pairing GPT-4o and Claude 4.5, which disagreed in 13 cases and agreed in 5 cases.
With just 8 disagreements and 10 agreements, the pairing of Gemini 2.5 and Claude 4.5 showed the lowest amount of disagreements out of all combinations.
This means that Gemini 2.5 and Claude 4.5 agreed more often than they disagreed.
On the other hand, any combination involving ChatGPT-4o resulted in more disagreements than agreements.

\section{Summary of Findings}

In summary, our experiments revealed that LLM navigation perfomance with additional symbolic geographic context was higher than without it.
