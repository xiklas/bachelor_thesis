...
Table 4.1 provides an overview of the two datasets used in our experiments.
...
Table 4.2 provides an overview of the trial outcomes.
...
When comparing the test group performance across the two test cities, we can make several observations.
...
Further, comparing the success rates across the three tested LLMs in the test group as depicted in Figure~4.2 yields additional insights. 
...
Breaking down the test group success rates by both test city and LLM as shown in Figure~4.3 leads to several additional observations.
...
Table~4.3 summarizes, for each navigation task, how many of the three tested models produced a response labelled as correct.
...
\hline
\end{tabular}
\caption{\textbf{Distribution of Correct Models in Single-Success Tasks.}}
...
The results of this analysis are summarized in Table~4.4.
...
The results of this analysis are summarized in Table~4.5.
