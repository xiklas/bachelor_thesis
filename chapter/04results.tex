...
We are first going to provide an overview of the results obtained from our experiments, before breaking down the results by different factors such as test city or LLM model.
In the end, we will present the results of our statistical significance testing.
These results will then be summarized and serve as the basis for the discussion following in the subsequent chapter.
