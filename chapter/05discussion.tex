...
This rapid model progress may reduce the marginal benefit of context enrichment as presented in this study over time, motivating repeated evaluation as new models are released.
...
However, our results could also be interpreted in another way: If it takes additional, non-trivial work to achieve better navigation performance with LLMs, maybe they are currently not the best tool for the job after all.
...
This study does not concern itself with mechanisms like these however.
