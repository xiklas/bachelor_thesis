...
Across all of the tested combinations, we observed improvements in trial success rates when qualitative geographic context was provided (see Table~4.3).
...
Although the reasoning capabilities of LLMs have been shown to be impressive in other areas, one possible explanation is that these are not sufficient for navigation tasks yet.
Another possible cause is a training-data blind spot.
This would mean that there is simply not enough relevant geographic information in the models' training data for effective navigation.
Our approach would then provide the LLMs with additional context to compensate for this blind spot.
...
At the same time, this does not imply that established navigation solutions are obsolete.
