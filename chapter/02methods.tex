...
After trial execution, each model's response was saved in a database. In case of an exceedingly verbose model response, the response was truncated to contain only the relevant navigational instructions which we want to investigate in this study.

\section{Evaluation Metrics and Statistical Analysis}

To enable evaluation and statistical analysis of the attained responses, each response was reviewed for correctness manually.
A response was labelled as correct if and only if the instructions allowed for continuous traversal from start to end point of the corresponding trial.
Any other routes which do not meet this criterium were labelled as incorrect.
Distance measures or number-of-turn measures are out of the scope of our study.