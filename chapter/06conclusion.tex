...
To test this hypothesis, we designed a series of experiments comparing LLM performance with navigation tasks in two independent conditions:
one with qualitative geographic context and one without.
We utilized randomly generated navigation tasks in our two chosen test areas (Münster and Hamburg) and let both conditions generate answers for each task.
...
In contrast, with additional geographic context, the models achieved a significantly higher performance, answering 75 out of 120 tasks correctly, corresponding to a success rate of 62.5\%.
...
Further, our evaluation was based on human labelling of large amounts of generated answers.
