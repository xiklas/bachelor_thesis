...
The software implementation used to generate the qualitative dipole relations was implemented primarily by James Odienki, and the code is available upon request.
